...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width:100%">
        ...
        <tr>
            <td>
                <form name="registrationFrm" id="registrationFrm" method="post" onsubmit="return validateForm(true);" onreset="resetErrorMsg();" action="RegistrationDB.aspx" >
                    <table>
                            <%
            ...
            <td style="width:35%">  
                <ul class="stickyNote" style="width:20em; height:22em;">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <li>מיקמתם את הקובץ MyAdoHelper <br />בתיקיית DB_Services.</li><br />
                                <li>מיקמתם את קובץ ה- ACCESS <br />בתיקיית App_Data.</li><br />
                                <li>התקנתם את ה- Provider לבסיס הנתונים. להורדת הקובץ <a href="Files/AccessDatabaseEngine.exe" download>לחצו כאן</a>.</li>
                            </td>
                        </tr>
                    </table>
