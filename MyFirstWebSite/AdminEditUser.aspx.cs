...
namespace MyFirstWebSite
{
    public partial class AdminEditUser : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (Request.Form["userMail"] != null) // אם נלחץ כפתור העדכון - לא עלייה ראשונה
                {
                    // שאילת הנתונים
                    ...
                    // הגדרת הטופס
                    edit = "<form name='updateForm' method='post' onsubmit='return validateForm(false)' action='AdminUpdateUser.aspx'>";
